        ...
        <div className="pass-card pass-card-face pass-card-back-face" style={{ margin: 0, ...style }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", width: "100%", marginBottom: 10 }}>
            <div style={{ paddingTop: 2 }}>
              ...
              <div style={{ fontSize: 8, color: "rgba(255,255,255,0.35)", marginTop: 6 }}>Official Accreditation Pass</div>
            </div>
            <div>
              <div style={{ background: "rgba(255,255,255,0.95)", padding: 8, borderRadius: 8, display: "inline-block" }}>
                <QRCode seed={qrSeed} size={80} />
              </div>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 8, color: "var(--gold)", letterSpacing: "0.06em", textAlign: "center", marginTop: 5 }}>{accId}</div>
            </div>
          </div>

          <div style={{ width: "100%", height: 1, background: "rgba(255,255,255,0.12)", marginBottom: 10, flexShrink: 0 }} />

          <div style={{ width: "100%", flex: 1, minHeight: 0, overflowY: "auto" }}>
            <div style={{ fontSize: 7.5, fontWeight: 700, color: "rgba(255,255,255,0.45)", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 7 }}>Terms of Use</div>
            <ol style={{ margin: 0, paddingLeft: 14, display: "flex", flexDirection: "column", gap: 4 }}>
              {[
                ...
                "Must be worn or carried visibly at all times within the venue premises.",
                ...
                <li key={i} style={{ fontSize: 8.5, color: "rgba(255,255,255,0.72)", lineHeight: 1.35 }}>{rule}</li>
              ))}
            </ol>
          </div>

          <div style={{ width: "100%", borderTop: "1px solid rgba(255,255,255,0.1)", marginTop: 10, paddingTop: 8, display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexShrink: 0 }}>
